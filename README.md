...
> 展示安徽美好形象的微信小程序，全面介绍安徽的美食文化、自然风景、历史文化底蕴。

## 📱 项目简介

「皖美」是一款基于 Taro + React + TypeScript 开发的微信小程序，采用徽派设计风格，展示安徽的独特魅力。

## 项目特点

- 🎨 **精美设计**：采用安徽山水蓝（#4A90E2）和古徽州墨绿（#2E4B3F）配色方案，8px圆角设计，融合徽派建筑元素
- 🍜 **美食文化**：展示徽州毛豆腐、臭鳜鱼、黄山烧饼、绩溪挞馃等安徽特色美食
- 🏔️ **自然风景**：介绍黄山、宏村、九华山、天柱山等著名景点
- 📚 **历史文化**：呈现徽文化、黄梅戏、宣纸、徽墨等文化瑰宝
- 🎯 **徽文化小问答**：互动式问答，了解安徽文化知识，答对收集印章
- 👍 **用户互动**：支持点赞、收藏、评论功能
- ⚙️ **内容管理**：全员可在小程序内可视化编辑内容（题库、景点、美食、文化）
